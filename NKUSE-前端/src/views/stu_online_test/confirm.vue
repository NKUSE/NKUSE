<template>
  <div class="container" style="min-height: 100%; padding-bottom: 100px;">
    ...
    <el-descriptions
      ...
      border
    >
      > <el-descriptions-item label="考生姓名">张三</el-descriptions-item>
      <el-descriptions-item label="考生身份证号"
        >232323232</el-descriptions-item
      >
      <el-descriptions-item label="考生ID" :span="2"
        >000001</el-descriptions-item
      >
      <el-descriptions-item label="报考科目">
        <el-tag size="small">英语6级</el-tag>
      </el-descriptions-item>
      <el-descriptions-item label="电子邮箱">11111@qq.com</el-descriptions-item>
    </el-descriptions>
